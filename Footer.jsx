      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-5">
            <a href="mailto:ansarmedia@ansarschool.in" aria-label="Email Us" className="text-slate-400 hover:text-white transition-colors">
            ...
            <a href={settings?.youtubeUrl || "#"} target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
