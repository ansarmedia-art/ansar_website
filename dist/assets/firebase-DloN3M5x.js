 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=-1;function to(r){return r==null}function as(r){return r===0&&1/r==-1/0}function KI(r){return typeof r=="number"&&Number.isInteger(r)&&!as(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const on="remoteDocuments",Ss="owner",kn="owner",cs="mutationQueues",HI="userId",$e="mutations",Vl="batchId",dn="userMutationsIndex",Dl=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fi(r,e){return[r,be(e)]}function nf(r,e,t){return[r,be(e),t]}const WI={},Yn="documentMutations",Ni="remoteDocumentsV14",QI=["prefixPath","collectionGroup","readTime","documentId"],mi="documentKeyIndex",JI=["prefixPath","collectionGroup","documentId"],rf="collectionGroupIndex",YI=["collectionGroup","readTime","prefixPath","documentId"],us="remoteDocumentGlobal",Ia="remoteDocumentGlobalKey",Xn="targets",sf="queryTargetsIndex",XI=["canonicalId","targetId"],Zn="targetDocuments",ZI=["targetId","path"],sc="documentTargetsIndex",eE=["path","targetId"],xi="targetGlobalKey",mn="targetGlobal",ls="collectionParents",tE=["collectionId","parent"],er="clientMetadata",nE="clientId",no="bundles",rE="bundleId",ro="namedQueries",sE="name",ic="indexConfiguration",iE="indexId",Ea="collectionGroupIndex",oE="collectionGroup",Jr="indexState",aE=["indexId","uid"],of="sequenceNumberIndex",cE=["uid","sequenceNumber"],Yr="indexEntries",uE=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],af="documentKeyIndex",lE=["indexId","uid","orderedDocumentKey"],so="documentOverlays",hE=["userId","collectionPath","documentId"],Ta="collectionPathOverlayIndex",dE=["userId","collectionPath","largestBatchId"],cf="collectionGroupOverlayIndex",fE=["userId","collectionGroup","largestBatchId"],oc="globals",mE="name",uf=[cs,$e,Yn,on,Xn,Ss,mn,Zn,er,us,ls,no,ro],pE=[...uf,so],lf=[cs,$e,Yn,Ni,Xn,Ss,mn,Zn,er,us,ls,no,ro,so],hf=lf,ac=[...hf,ic,Jr,Yr],gE=ac,df=[...ac,oc],_E=df;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gs{constructor(e,t="asc"){this.field=e,this.dir=t}}function vE(r,e){return r.dir===e.dir&&r.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VE{constructor(e,t=null,n=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.Te=null}}function Pa(r,e=null,t=[],n=[],s=null,i=null,o=null){return new VE(r,e,t,n,s,i,o)}function vn(r){const e=j(r);if(e.Te===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(n=>Ra(n)).join(","),t+="|ob:",t+=e.orderBy.map(n=>function(i){return i.field.canonicalString()+i.dir}(n)).join(","),to(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(n=>nr(n)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(n=>nr(n)).join(",")),e.Te=t}return e.Te}function Cs(r,e){if(r.limit!==e.limit||r.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<r.orderBy.length;t++)if(!vE(r.orderBy[t],e.orderBy[t]))return!1;if(r.filters.length!==e.filters.length)return!1;for(let t=0;t<r.filters.length;t++)if(!Pf(r.filters[t],e.filters[t]))return!1;return r.collectionGroup===e.collectionGroup&&!!r.path.isEqual(e.path)&&!!ql(r.startAt,e.startAt)&&ql(r.endAt,e.endAt)}function Mi(r){return O.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}function Li(r,e){return r.filters.filter(t=>t instanceof W&&t.field.isEqual(e))}function jl(r,e,t){let n=pi,s=!0;for(const i of Li(r,e)){let o=pi,c=!0;switch(i.op){case"<":case"<=":o=TE(i.value);break;case"==":case"in":case">=":o=i.value;break;case">":o=i.value,c=!1;break;case"!=":case"not-in":o=pi}Fl({value:n,inclusive:s},{value:o,inclusive:c})<0&&(n=o,s=c)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];Fl({value:n,inclusive:s},{value:o,inclusive:t.inclusive})<0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}function zl(r,e,t){let n=kt,s=!0;for(const i of Li(r,e)){let o=kt,c=!0;switch(i.op){case">=":case">":o=wE(i.value),c=!1;break;case"==":case"in":case"<=":o=i.value;break;case"<":o=i.value,c=!1;break;case"!=":case"not-in":o=kt}Ul({value:n,inclusive:s},{value:o,inclusive:c})>0&&(n=o,s=c)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];Ul({value:n,inclusive:s},{value:o,inclusive:t.inclusive})>0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const LE=new ie(O.comparator);function Le(){return LE}const xf=new ie(O.comparator);function zr(...r){let e=xf;for(const t of r)e=e.insert(t.key,t);return e}function Of(r){let e=xf;return r.forEach((t,n)=>e=e.insert(t,n.overlayedDocument)),e}function Xe(){return es()}function Mf(){return es()}function es(){return new pt(r=>r.toString(),(r,e)=>r.isEqual(e))}const FE=new ie(O.comparator),UE=new te(O.comparator);function K(...r){let e=UE;for(const t of r)e=e.add(t);return e}const BE=new te(B);function qE(){return BE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function co(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:as(e)?"-0":e}}function dc(r){return{integerValue:""+r}}function jE(r,e){return KI(e)?dc(e):co(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uo{constructor(){this._=void 0}}function zE(r,e,t){return r instanceof ir?function(s,i){const o={fields:{[gf]:{stringValue:pf},[yf]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&cc(i)&&(i=io(i)),i&&(o.fields[_f]=i),{mapValue:o}}(t,e):r instanceof or?Ff(r,e):r instanceof ar?Uf(r,e):r instanceof cr?function(s,i){const o=Lf(s,i),c=Ui(o)+Ui(s.Ae);return ms(o)&&ms(s.Ae)?dc(c):co(s.serializer,c)}(r,e):r instanceof _s?function(s,i){return Kl(s,i,Math.min)}(r,e):r instanceof ys?function(s,i){return Kl(s,i,Math.max)}(r,e):void 0}function $E(r,e,t){return r instanceof or?Ff(r,e):r instanceof ar?Uf(r,e):t}function Lf(r,e){return r instanceof cr?Ef(e)?e:{integerValue:0}:null}class ir extends uo{}class or extends uo{constructor(e){super(),this.elements=e}}function Ff(r,e){const t=Bf(e);for(const n of r.elements)t.some(s=>nt(s,n))||t.push(n);return{arrayValue:{values:t}}}class ar extends uo{constructor(e){super(),this.elements=e}}function Uf(r,e){let t=Bf(e);for(const n of r.elements)t=t.filter(s=>!nt(s,n));return{arrayValue:{values:t}}}class fc extends uo{constructor(e,t){super(),this.serializer=e,this.Ae=t}}class cr extends fc{}class _s extends fc{}class ys extends fc{}function Kl(r,e,t){if(!Ef(e))return r.Ae;const n=t(Ui(e),Ui(r.Ae));return ms(e)&&ms(r.Ae)?dc(n):co(r.serializer,n)}function Ui(r){return oe(r.integerValue||r.doubleValue)}function Bf(r){return ps(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pT{St(e){return _e(e,oc)}getSessionToken(e){return this.St(e).get("sessionToken").next(t=>{const n=t==null?void 0:t.value;return n?fe.fromUint8Array(n):fe.EMPTY_BYTE_STRING})}setSessionToken(e,t){return this.St(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class TT{constructor(){this.Sn=new Ec}addToCollectionParentIndex(e,t){return this.Sn.add(t),v.resolve()}getCollectionParents(e,t){return v.resolve(this.Sn.getEntries(t))}addFieldIndex(e,t){return v.resolve()}deleteFieldIndex(e,t){return v.resolve()}deleteAllFieldIndexes(e){return v.resolve()}createTargetIndexes(e,t){return v.resolve()}getDocumentsMatchingTarget(e,t){return v.resolve(null)}getIndexType(e,t){return v.resolve(0)}getFieldIndexes(e,t){return v.resolve([])}getNextCollectionGroupToUpdate(e){return v.resolve(null)}getMinOffset(e,t){return v.resolve(Ue.min())}getMinOffsetFromCollectionGroup(e,t){return v.resolve(Ue.min())}updateCollectionGroup(e,t,n){return v.resolve()}updateIndexEntries(e,t){return v.resolve()}}class Ec{constructor(){this.index={}}add(e){const t=e.lastSegment(),n=e.popLast(),s=this.index[t]||new te(X.comparator),i=!s.has(n);return this.index[t]=s.add(n),i}has(e){const t=e.lastSegment(),n=e.popLast(),s=this.index[t];return s&&s.has(n)}getEntries(e){return(this.index[e]||new te(X.comparator)).toArray()}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Em{constructor(){this.Es=!1,this.Rs=!1,this.As=100,this.Vs=function(){return Xh()?8:tf(pe())>0?6:4}()}initialize(e,t){this.ds=e,this.indexManager=t,this.Es=!0}getDocumentsMatchingQuery(e,t,n,s){const i={result:null};return this.fs(e,t).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.gs(e,t,s,n).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new jT;return this.ps(e,t,o).next(c=>{if(i.result=c,this.Rs)return this.ys(e,t,o,c.size)})}).next(()=>i.result)}ys(e,t,n,s){return n.documentReadCount<this.As?(Fn()<=H.DEBUG&&C("QueryEngine","SDK will not create cache indexes for query:",Un(t),"since it only creates cache indexes for collection contains","more than or equal to",this.As,"documents"),v.resolve()):(Fn()<=H.DEBUG&&C("QueryEngine","Query:",Un(t),"scans",n.documentReadCount,"local documents and returns",s,"documents as results."),n.documentReadCount>this.Vs*s?(Fn()<=H.DEBUG&&C("QueryEngine","The SDK decides to create cache indexes for query:",Un(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,je(t))):v.resolve())}fs(e,t){if($l(t))return v.resolve(null);let n=je(t);return this.indexManager.getIndexType(e,n).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=Fi(t,null,"F"),n=je(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next(i=>{const o=K(...i);return this.ds.getDocuments(e,o).next(c=>this.indexManager.getMinOffset(e,n).next(u=>{const h=this.ws(t,c);return this.Ss(t,h,o,u.readTime)?this.fs(e,Fi(t,null,"F")):this.bs(e,h,t,u)}))})))}gs(e,t,n,s){return $l(t)||s.isEqual(F.min())?v.resolve(null):this.ds.getDocuments(e,n).next(i=>{const o=this.ws(t,i);return this.Ss(t,o,n,s)?v.resolve(null):(Fn()<=H.DEBUG&&C("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Un(t)),this.bs(e,o,t,BI(s,is)).next(c=>c))})}ws(e,t){let n=new te(Nf(e));return t.forEach((s,i)=>{Ds(e,i)&&(n=n.add(i))}),n}Ss(e,t,n,s){if(e.limit===null)return!1;if(n.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ps(e,t,n){return Fn()<=H.DEBUG&&C("QueryEngine","Using full collection scan to execute query:",Un(t)),this.ds.getDocumentsMatchingQuery(e,t,Ue.min(),n)}bs(e,t,n,s){return this.ds.getDocumentsMatchingQuery(e,n,s).next(i=>(t.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oa="RestConnection",XT={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class ZT{get ko(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.qo=t+"://"+e.host,this.Ko=`projects/${n}/databases/${s}`,this.Uo=this.databaseId.database===Oi?`project_id=${n}`:`project_id=${n}&database_id=${s}`}$o(e,t,n,s,i){const o=Ma(),c=this.Wo(e,t.toUriEncodedString());C(oa,`Sending RPC '${e}' ${o}:`,c,n);const u={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Uo};this.Qo(u,s,i);const{host:h}=new URL(c),f=ws(h);return this.Go(e,c,u,n,f).then(p=>(C(oa,`Received RPC '${e}' ${o}: `,p),p),p=>{throw Ut(oa,`RPC '${e}' ${o} failed with error: `,p,"url: ",c,"request:",n),p})}zo(e,t,n,s,i,o){return this.$o(e,t,n,s,i)}Qo(e,t,n){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+fr}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,i)=>e[i]=s),n&&n.headers.forEach((s,i)=>e[i]=s)}Wo(e,t){const n=XT[e];let s=`${this.qo}/v1/${t}:${n}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ew{constructor(e){this.jo=e.jo,this.Jo=e.Jo}Ho(e){this.Zo=e}Xo(e){this.Yo=e}e_(e){this.t_=e}onMessage(e){this.n_=e}close(){this.Jo()}send(e){this.jo(e)}r_(){this.Zo()}i_(){this.Yo()}s_(e){this.t_(e)}o_(e){this.n_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nw(){return typeof window<"u"?window:null}function Ti(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function go(r){return new rT(r,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rt="RemoteStore";class uw{constructor(e,t,n,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Map,this.Ea=new Map,this.Ra=new dt(1e3),this.Aa=new dt(1001),this.Va=new Set,this.da=[],this.ma=i,this.ma.Fo(o=>{n.enqueueAndForget(async()=>{Sn(this)&&(C(rt,"Restarting streams for network reachability change."),await async function(u){const h=j(u);h.Va.add(4),await xs(h),h.fa.set("Unknown"),h.Va.delete(4),await _o(h)}(this))})}),this.fa=new cw(n,s)}}async function _o(r){if(Sn(r))for(const e of r.da)await e(!0)}async function xs(r){for(const e of r.da)await e(!1)}function La(r,e){return r.Ia.get(e)||void 0}function bm(r,e){const t=j(r),n=La(t,e.targetId);if(n!==void 0&&t.Ta.has(n))return;const s=function(c,u){const h=La(c,u);h!==void 0&&c.Ea.delete(h);const f=function(I,b){return b%2!=0?I.Aa.next():I.Ra.next()}(c,u);return c.Ia.set(u,f),c.Ea.set(f,u),f}(t,e.targetId);C(rt,"remoteStoreListen mapping SDK target ID to remote",e.targetId,s);const i=new Ze(e.target,s,e.purpose,e.sequenceNumber,e.snapshotVersion,e.lastLimboFreeSnapshotVersion,e.resumeToken);t.Ta.set(s,i),Cc(t)?Sc(t):gr(t).x_()&&bc(t,i)}function Pc(r,e){const t=j(r),n=gr(t),s=La(t,e);C(rt,"remoteStoreUnlisten removing mapping of SDK target ID to remote",e,s),t.Ta.delete(s),t.Ia.delete(e),t.Ea.delete(s),n.x_()&&Sm(t,s),t.Ta.size===0&&(n.x_()?n.B_():Sn(t)&&t.fa.set("Unknown"))}function bc(r,e){if(r.ga.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(F.min())>0){const t=r.Ea.get(e.targetId);if(t===void 0)return void C(rt,"SDK target ID not found for remote ID: "+e.targetId);const n=r.remoteSyncer.getRemoteKeysForTarget(t).size;e=e.withExpectedCount(n)}gr(r).H_(e)}function Sm(r,e){r.ga.$e(e),gr(r).Z_(e)}function Sc(r){r.ga=new ZE({getRemoteKeysForTarget:e=>{const t=r.Ea.get(e);return t!==void 0?r.remoteSyncer.getRemoteKeysForTarget(t):K()},Rt:e=>r.Ta.get(e)||null,lt:()=>r.datastore.serializer.databaseId}),gr(r).start(),r.fa.aa()}function Cc(r){return Sn(r)&&!gr(r).M_()&&r.Ta.size>0}function Sn(r){return j(r).Va.size===0}function Cm(r){r.ga=void 0}async function lw(r){r.fa.set("Online")}async function hw(r){r.Ta.forEach((e,t)=>{bc(r,e)})}async function dw(r,e){Cm(r),Cc(r)?(r.fa.la(e),Sc(r)):r.fa.set("Unknown")}async function fw(r,e,t){if(r.fa.set("Online"),e instanceof Hf&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const c of i.targetIds){if(s.Ta.has(c)){const u=s.Ea.get(c);u!==void 0&&(await s.remoteSyncer.rejectListen(u,o),s.Ia.delete(u),s.Ea.delete(c)),s.Ta.delete(c)}s.ga.removeTarget(c)}}(r,e)}catch(n){C(rt,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Gi(r,n)}else if(e instanceof Ii?r.ga.Xe(e):e instanceof Gf?r.ga.it(e):r.ga.tt(e),!t.isEqual(F.min()))try{const n=await vm(r.localStore);t.compareTo(n)>=0&&await function(i,o){const c=i.ga.Pt(o);c.targetChanges.forEach((h,f)=>{if(h.resumeToken.approximateByteSize()>0){const p=i.Ta.get(f);p&&i.Ta.set(f,p.withResumeToken(h.resumeToken,o))}}),c.targetMismatches.forEach((h,f)=>{const p=i.Ta.get(h);if(!p)return;i.Ta.set(h,p.withResumeToken(fe.EMPTY_BYTE_STRING,p.snapshotVersion)),Sm(i,h);const I=new Ze(p.target,h,f,p.sequenceNumber);bc(i,I)});const u=function(f,p){const I=new Map;p.targetChanges.forEach((V,x)=>{const k=f.Ea.get(x);k!==void 0&&I.set(k,V)});let b=new ie(B);return p.targetMismatches.forEach((V,x)=>{const k=f.Ea.get(V);k!==void 0&&(b=b.insert(k,x))}),new ks(p.snapshotVersion,I,b,p.documentUpdates,p.resolvedLimboDocuments)}(i,c);return i.remoteSyncer.applyRemoteEvent(u)}(r,t)}catch(n){C(rt,"Failed to raise snapshot:",n),await Gi(r,n)}}async function Gi(r,e,t){if(!Ht(e))throw e;r.Va.add(1),await xs(r),r.fa.set("Offline"),t||(t=()=>vm(r.localStore)),r.asyncQueue.enqueueRetryable(async()=>{C(rt,"Retrying IndexedDB access"),await t(),r.Va.delete(1),await _o(r)})}function Vm(r,e){return e().catch(t=>Gi(r,t,e))}async function Os(r){const e=j(r),t=jt(e);let n=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:fn;for(;mw(e);)try{const s=await WT(e.localStore,n);if(s===null){e.Pa.length===0&&t.B_();break}n=s.batchId,pw(e,s)}catch(s){await Gi(e,s)}Dm(e)&&km(e)}function mw(r){return Sn(r)&&r.Pa.length<10}function pw(r,e){r.Pa.push(e);const t=jt(r);t.x_()&&t.X_&&t.Y_(e.mutations)}function Dm(r){return Sn(r)&&!jt(r).M_()&&r.Pa.length>0}function km(r){jt(r).start()}async function gw(r){jt(r).na()}async function _w(r){const e=jt(r);for(const t of r.Pa)e.Y_(t.mutations)}async function yw(r,e,t){const n=r.Pa.shift(),s=pc.from(n,e,t);await Vm(r,()=>r.remoteSyncer.applySuccessfulWrite(s)),await Os(r)}async function Iw(r,e){e&&jt(r).X_&&await async function(n,s){if(function(o){return JE(o)&&o!==S.ABORTED}(s.code)){const i=n.Pa.shift();jt(n).N_(),await Vm(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Os(n)}}(r,e),Dm(r)&&km(r)}async function Ph(r,e){const t=j(r);t.asyncQueue.verifyOperationInProgress(),C(rt,"RemoteStore received new credentials");const n=Sn(t);t.Va.add(3),await xs(t),n&&t.fa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Va.delete(3),await _o(t)}async function Ew(r,e){const t=j(r);e?(t.Va.delete(2),await _o(t)):e||(t.Va.add(2),await xs(t),t.fa.set("Unknown"))}function gr(r){return r.pa||(r.pa=function(t,n,s){const i=j(t);return i.ia(),new rw(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(r.datastore,r.asyncQueue,{Ho:lw.bind(null,r),Xo:hw.bind(null,r),e_:dw.bind(null,r),J_:fw.bind(null,r)}),r.da.push(async e=>{e?(r.pa.N_(),Cc(r)?Sc(r):r.fa.set("Unknown")):(await r.pa.stop(),Cm(r))})),r.pa}function jt(r){return r.ya||(r.ya=function(t,n,s){const i=j(t);return i.ia(),new sw(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(r.datastore,r.asyncQueue,{Ho:()=>Promise.resolve(),Xo:gw.bind(null,r),e_:Iw.bind(null,r),ea:_w.bind(null,r),ta:yw.bind(null,r)}),r.da.push(async e=>{e?(r.ya.N_(),await Os(r)):(await r.ya.stop(),r.Pa.length>0&&(C(rt,`Stopping write stream with ${r.Pa.length} pending writes`),r.Pa=[]))})),r.ya}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qw="ComponentProvider",Nh=new Map;function Jw(r,e,t,n,s){return new IE(r,e,t,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,Hm(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rp extends av{constructor(e){super(),this.firestore=e}convertBytes(e){return new Be(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new le(this.firestore,null,t)}}function vv(){return new Fc("serverTimestamp")}const Uh="@firebase/firestore",Bh="4.15.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sv(r){r=Fe(r,le);const e=Fe(r.firestore,ft),t=Oc(e);return Hw(t,r._key).then(n=>ap(e,r,n))}function Cv(r,e,t){r=Fe(r,le);const n=Fe(r.firestore,ft),s=op(r.converter,e,t),i=Eo(n);return vo(n,[Xm(i,"setDoc",r._key,s,r.converter!==null,t).toMutation(r._key,Pe.none())])}function Vv(r,e,t,...n){r=Fe(r,le);const s=Fe(r.firestore,ft),i=Eo(s);let o;return o=typeof(e=ge(e))=="string"||e instanceof Mc?sv(i,"updateDoc",r._key,e,t,n):rv(i,"updateDoc",r._key,e),vo(s,[o.toMutation(r._key,Pe.exists(!0))])}function Dv(r){return vo(Fe(r.firestore,ft),[new ho(r._key,Pe.none())])}function kv(r,e){const t=Fe(r.firestore,ft),n=Xw(r),s=op(r.converter,e),i=Eo(r.firestore);return vo(t,[Xm(i,"addDoc",n._key,s,r.converter!==null,{}).toMutation(n._key,Pe.exists(!1))]).then(()=>n)}function Nv(r,...e){var h,f,p;r=ge(r);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||qh(e[n])||(t=e[n++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(qh(e[n])){const I=e[n];e[n]=(h=I.next)==null?void 0:h.bind(I),e[n+1]=(f=I.error)==null?void 0:f.bind(I),e[n+2]=(p=I.complete)==null?void 0:p.bind(I)}let i,o,c;if(r instanceof le)o=Fe(r.firestore,ft),c=Vs(r._key.path),i={next:I=>{e[n]&&e[n](ap(o,r,I))},error:e[n+1],complete:e[n+2]};else{const I=Fe(r,Qt);o=Fe(I.firestore,ft),c=I._query;const b=new rp(o);i={next:V=>{e[n]&&e[n](new Wn(o,b,I,V))},error:e[n+1],complete:e[n+2]},uv(r._query)}const u=Oc(o);return Gw(u,c,s,i)}function vo(r,e){const t=Oc(r);return Ww(t,e)}function ap(r,e,t){const n=t.docs.get(e._key),s=new rp(r);return new gn(r,s,e._key,n,new Gr(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){SI(hr),Qn(new yn("firestore",(n,{instanceIdentifier:s,options:i})=>{const o=n.getProvider("app").getImmediate(),c=new ft(new DI(n.getProvider("auth-internal")),new xI(o,n.getProvider("app-check-internal")),EE(o,s),o);return i={useFetchStreams:t,...i},c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),Ot(Uh,Bh,e),Ot(Uh,Bh,"esm2020")})();var hv="firebase",dv="12.14.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ot(hv,dv,"app");export{St as G,yv as a,Nv as b,Ev as c,Xw as d,wv as e,Cv as f,Tv as g,Dv as h,a_ as i,kv as j,Sv as k,bv as l,pv as m,gv as n,Pv as o,_v as p,Av as q,fv as r,vv as s,mv as t,Vv as u,Rv as w};
